...
{
    public class CourseraInteractionPage1
    {
        private readonly IWebDriver driver;

        public CourseraInteractionPage1(IWebDriver driver)
        {
            this.driver = driver;
        }
    ...
    public class TestClass3
    {
        ...
        public CourseraInteractionPage1? courseraInteractionPage;
        ...
        public void Setup()
        {
            ...
            courseraInteractionPage = new CourseraInteractionPage1(driver);
        }
